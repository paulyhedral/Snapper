...
@interface SNCreateMessageOperation : SNBaseOAuthOperation
...
/**
 * An array of SNAnnotation objects to include in the message.
 */
@property (nonatomic, retain) NSArray* annotations;
/**
 * An array of SNEntity-subclassed objects, e.g., SNMention, SNHashtag, or SNLink to include in the message.
 */
